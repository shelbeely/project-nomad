...
export default class ServiceSeeder extends BaseSeeder {
  ...
  >[] = [
    ...
    {
      service_name: SERVICE_NAMES.IA_MIRROR,
      friendly_name: 'Internet Archive Mirror',
      powered_by: 'Internet Archive / dweb-mirror',
      display_order: 12,
      description: '38M+ books, historical documents, audio, video, and software from the Internet Archive — cacheable offline',
      ...
      container_config: JSON.stringify({
        HostConfig: {
          ...
          Binds: [`${ServiceSeeder.NOMAD_STORAGE_ABS_PATH}/ia-mirror:/usr/local/dweb-mirror/.data`],
        },
